  ...
  return (
    <section className="w-full max-w-7xl mx-auto px-6 md:px-12 lg:px-24 relative flex items-center justify-center min-h-[60vh]">
      ...
      <motion.div 
        ...
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] md:w-[600px] h-[300px] md:h-[600px] bg-cyan-500 rounded-full mix-blend-screen filter blur-[150px] md:blur-[250px] opacity-10 pointer-events-none"
      />
      ...
      >
        ...
        <h3 className="text-3xl md:text-5xl lg:text-6xl font-light leading-snug md:leading-tight text-slate-200 drop-shadow-2xl">
