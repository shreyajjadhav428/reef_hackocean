  ...
  return (
    <div className="min-h-screen bg-[#03045E] text-white pt-24 pb-12 px-6 md:px-12 lg:px-24 font-sans selection:bg-[#48CAE4] selection:text-[#03045E]">
      ...
      >
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start mb-16 relative">
          <motion.div variants={itemVariants} className="lg:w-1/2 z-10">
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-light leading-tight mb-6 text-[#CAF0F8]">
              Let's Build a <br />
              <span className="font-semibold">Better Ocean Together.</span>
            </h1>
            <p className="text-[#ADE8F4] text-lg max-w-md leading-relaxed">
              Whether you have a question, an idea, or simply want to share your passion for the ocean, we'd love to hear from you.
            </p>
          </motion.div>
        ...
        {/* Map Section */}
        <motion.div variants={itemVariants} className="bg-[#023E8A]/40 border border-[#48CAE4]/20 rounded-2xl p-6 lg:p-8 backdrop-blur-md shadow-2xl mb-12 flex flex-col md:flex-row items-center gap-8">
        ...
        <motion.div variants={itemVariants} className="text-center py-8 mb-8">
          <p className="text-2xl md:text-3xl text-[#48CAE4] font-light italic leading-relaxed max-w-4xl mx-auto drop-shadow-md">
            "The ocean's future isn't written by a single wave. <br className="hidden md:block"/> It's written by every ripple we choose to create."
          </p>
        </motion.div>
